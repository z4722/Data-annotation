...
def _init_session_state() -> None:
    ...
    default_process_path = _edit_process_json_path(default_output_path)
    defaults = {
        "current_index": 0,
        "current_failed_pos": 0,
        "is_locked": False,
        "abandon_selected": False,
        "input_json_path": str(EDIT_INPUT_JSON_DEFAULT),
        "active_input_json_path": str(EDIT_INPUT_JSON_DEFAULT),
...
def main() -> None:
    st.set_page_config(page_title="Media Edit Tool", layout="wide")
